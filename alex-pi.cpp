...
void handleStatus(TPacket *packet)
{
	...
	//printf("Colour:\t\t%d\n", packet->params[10]);
    //colour has unconfirmed data format
	//printf("Flame:\t\t%c\n", (packet->params[11])? 'Y' : 'N');
	//printf("Gas:\t\t%c\n", (packet->params[12])? 'Y' : 'N');
	printf("\n---------------------------------------\n\n");
}
...
int main()
{
	...
	{
		char ch;
		printf("Command (f=forward, b=reverse, l=turn left, r=turn right, p=stop, c=clear stats, g=get stats q=exit, w=forward 5cm, s=reverse 5cm, a=left 3 deg, d=right 3 deg)\n");
		scanf("%c", &ch);
